...
>
  <head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="<?= base_url('assets/temp/') ?>/assets/vendor/css/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="<?= base_url('assets/temp/') ?>/assets/vendor/css/theme-default.css" class="template-customizer-theme-css" />
  ...
  <body>
    ...
    <!-- Kategori -->
    <li class="menu-item <?= ($this->uri->segment(2) == 'kategori') ? 'active' : '' ?>">
        <a href="<?= base_url('admin/kategori') ?>" class="menu-link">
            <i class="menu-icon tf-icons bx bx-list-ul"></i>
            <div data-i18n="Analytics">Kategori</div>
        </a>
    </li>
    <li class="menu-item <?= ($this->uri->segment(2) == 'karya') ? 'active' : '' ?>">
        <a href="<?= base_url('admin/karya') ?>" class="menu-link">
            <i class="menu-icon tf-icons bx bx-list-ul"></i>
            <div data-i18n="Analytics">Karya</div>
        </a>
    </li>
</ul>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="<?= base_url('assets/temp/') ?>/assets/img/avatars/1.png" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
    ...
    <script>
    setTimeout(function() {
        var notif = document.getElementById('menghilang');
        if (notif) {
            notif.style.transition = "opacity 0.5s ease";
            notif.style.opacity = 0;
            setTimeout(function() {
                notif.remove();
            }, 500); // tunggu efek fade
        }
